  ...
  return (
    <div className="card border-dark mb-3 grid-item"> 
      ...
      <div className="card-body">
        ...
        <a href={props.repo} target="_blank" rel="noreferrer noopener"className="btn btn-dark btn-rounded"><strong>Repo</strong></a>
        <a href={props.deployedURL} target="_blank" rel="noreferrer noopener" className="btn btn-dark btn-rounded"><strong>Live URL</strong></a>
      </div>
    </div>
  );
}
